...
pairwise_condorcet = function(voters, options){
  ...
  a = df[,1] + df[,2] + df[,3] + df[,4] + df[,5] + df[,6]
  
  better_than_b = which(a + df[,13] + df[,14] + df[,17] + df[,19] + df[,20] + df[,23] > 
                     df[,7] + df[,8] + df[,9] + df[,10] + df[,11] + df[,12] + 
                     df[,15] + df[,16] + df[,18] + df[,21] + df[,22] + df[,24])


  better_than_c = which(a + df[,7] + df[,8] + df[,11] + df[,19] + df[,20] + df[,21] > 
                     df[,13] + df[,14] + df[,15] + df[,16] + df[,17] + df[,18] + 
                     df[,9] + df[,10] + df[,12] + df[,22] + df[,23] + df[,24])

  better_than_d = which(a + df[,7] + df[,8] + df[,9] + df[,13] + df[,14] + df[,15] > 
                     df[,19] + df[,20] + df[,21] + df[,22] + df[,23] + df[,24] + 
                     df[,10] + df[,11] + df[,12] + df[,16] + df[,17] + df[,18])

   
  most_preferred = intersect(intersect(better_than_b, better_than_c),better_than_d)
